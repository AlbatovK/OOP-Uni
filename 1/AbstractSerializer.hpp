 ...
 * \version 1.0
 * Base Generic Serializer Interface, used for transforming ojects into string format and vice-versa
 * Contains prototypes of varios serialization/deserialization functions
 */
template <class T> 
